...
public final class Notification {
  ...
  private String createOrGetChannelForSound(String soundFileUri) {
    NotificationManager mgr = getNotMgr();

    String channelId = Manager.getChannelIdForSound(soundFileUri);
    ...
    channel = new NotificationChannel(channelId, CHANNEL_NAME, IMPORTANCE_DEFAULT);
    //np. Uri sound = Uri.parse("file:///storage/emulated/0/Notifications/slow-spring-board.mp3"); działa
    Uri sound = Uri.parse(soundFileUri);
  ...
  private static final CharSequence CHANNEL_NAME = "Default channel";
    ...
    public void show() {
      ...
      createOrGetChannelForSound(options.getSoundFileUri());
